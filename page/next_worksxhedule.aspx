...
<body>
  <center>  <P1>เลื่อนการปฏิบัติงาน  </P1>
      &nbsp;</center>
         <table style="width: 100%;">
             ...
             <tr>
                    <td>ชื่อแพทย์ </td>
                     <td>  <asp:TextBox ID="txtdocname" class="form-control"  runat="server" Height="42px" Width="256px" Enabled="False" OnTextChanged="txtdocname_TextChanged"></asp:TextBox></td>
                 </tr>
  ...
  <center><asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataSourceID="SqlDataSource1" GridLines="Vertical" Height="136px" Width="714px" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" DataKeyNames="swd_id">
      ...
      <Columns>
          ...
          <asp:BoundField DataField="swd_id" HeaderText="รหัสอ้างอิงตารางงาน" SortExpression="swd_id" InsertVisible="False" ReadOnly="True" />
          <asp:BoundField DataField="swd_day_work" HeaderText="วัน" SortExpression="swd_day_work" />
          <asp:BoundField DataField="swd_start_time" HeaderText="วันเริ่มปฏิบัติงาน" SortExpression="swd_start_time" />
          <asp:BoundField DataField="swd_end_time" HeaderText="วันเลิกปฏิบัติงาน" SortExpression="swd_end_time" />
      ...
      <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:connectionstring %>" SelectCommand="select swd_id,swd_day_work,swd_start_time,swd_end_time,room_id  from schedule_work_doctor inner join employee_doctor on employee_doctor.emp_doc_id = schedule_work_doctor.emp_doc_id where swd_status_room = 1 AND employee_doctor.emp_doc_name =@emp_doc_name">
          <SelectParameters>
